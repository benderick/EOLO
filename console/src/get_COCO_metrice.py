...
def parse_opt():
    ...
    parser.add_argument('--pred_json', type=str, default='/icislab/volume3/benderick/futurama/ultralytics/runs/detect/val35/val_pred_coco.json', help='pred coco json path')
